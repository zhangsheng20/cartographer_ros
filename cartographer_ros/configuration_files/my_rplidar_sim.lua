...
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds=10/TRAJECTORY_BUILDER_2D.submaps.num_range_data
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters=1/TRAJECTORY_BUILDER_2D.submaps.num_range_data
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians 
        = math.rad(45/TRAJECTORY_BUILDER_2D.submaps.num_range_data/POSE_GRAPH.optimize_every_n_nodes)
